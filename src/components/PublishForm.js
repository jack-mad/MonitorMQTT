      ...
      <Form onSubmit={handleSubmit}>
        <Form.Row>
          <Form.Group as={Col} xs={12} md={3}>
            <Form.Control ref={topicInput} name="publish-topic" type="text" placeholder="Tópico" />
          </Form.Group>
          <Form.Group as={Col} xs={12} md={7}>
            <Form.Control ref={messageInput} name="publish-message" type="text" placeholder="Mensaje" />
          </Form.Group>
